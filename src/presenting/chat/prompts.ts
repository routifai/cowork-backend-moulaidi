/**
 * System prompts for the chat editing AI.
 * Port of presenting/engine/services/chat/prompts.py — verbatim prompt text
 * preserved for identical LLM behavior.
 */
...
const CHAT_AI_ASSISTANT_SYSTEM_PROMPT = `
...
export function buildSystemPrompt(
  presentationMemoryContext: string,
  chatMemoryContext: string,
  ...
  const basePrompt = presentationType === "smart" ? SMART_CHAT_AI_ASSISTANT_SYSTEM_PROMPT : CHAT_AI_ASSISTANT_SYSTEM_PROMPT;
